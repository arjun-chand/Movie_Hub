      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form className="d-flex" role="search">
            <button className="btn btn-outline-success mx-2" type="submit">Upload a Movie</button>
            <button className="btn btn-outline-danger mx-2" type="submit">Delete a Movie</button>
            <button className="btn btn-outline-warning mx-2" type="submit">Update a Movie</button>
          </form>
        </div>
      </div>
    </nav>
